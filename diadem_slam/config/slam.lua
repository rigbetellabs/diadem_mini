...
options = {
  ...
  map_frame = "map",
  -- When not using IMU, tracking frame is base_link
  ...
  -- Standalone scan-matching mode: no external odometry, Cartographer generates odom->base_link
  use_odometry = false,
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 1,
...
-- No IMU, no external odometry: rely purely on laser scan matching
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 30.
