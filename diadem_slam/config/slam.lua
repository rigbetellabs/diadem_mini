...
options = {
  ...
  map_frame = "map",
  -- When using IMU, tracking frame MUST be the IMU link
  ...
  -- Trust the wheels and laser, ignore the IMU
  use_odometry = true,
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 1,
...
-- Enable native Cartographer IMU fusion for ultra-precise rotational tracking
