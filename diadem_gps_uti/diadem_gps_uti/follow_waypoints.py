...
from diadem_gps_uti.utils.gps_utils import latLonYaw2Geopose
...
def main():
    ...
    default_yaml_file_path = "/home/rigbetellabs/gps_ws/src/diadem_gps_uti/diadem_gps_uti/gps_waypoints.yaml"
    if len(sys.argv) > 1:
