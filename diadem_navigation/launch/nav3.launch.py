...
def generate_launch_description():
    ...
    # nav2_yaml = os.path.join(get_package_share_directory('diadem_navigation'), 'config', 'nav2_params_simulation.yaml')
    nav2_yaml = os.path.join(get_package_share_directory('diadem_navigation'), 'config', 'nav2_params.yaml')
    ...
    # params_file = '/home/rigbetel_labs/ros2_ws/src/diadem_private/diadem_navigation/config/nav2_params_simulation.yaml'
